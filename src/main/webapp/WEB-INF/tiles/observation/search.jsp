...
$(document).ready(function(){
	$("#domain-option").on('change', function(){
		...
		$.get("<%=request.getContextPath()%>/observation/search/domainoption", { option: selectedOption },
			function(data){
				$("#box-observation").html(data);	
		});
	});	
});
</script>
...
<div class="col-md-9">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2 class="panel-title">Search for Observations</h2>
		</div>
