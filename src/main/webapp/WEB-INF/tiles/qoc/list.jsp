...
$(document).ready(function(){
	$("#domain-option").on('change', function(){
		...
		$.get("<%=request.getContextPath()%>/qoc/domainoption", { option: selectedOption },
			function(data){
				$("#box-qoccriteria").html(data);	
		});
	});	
});
</script>
...
<div class="col-md-9">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h2 class="panel-title">List of QoC Criteria</h2>
		</div>
